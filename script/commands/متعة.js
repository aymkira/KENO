...
if (event.senderID != 61584059280197) return api.sendMessage("روح نام الامر ذا لانس فقط", event.threadID);
 function delay(ms) {
...
api.sendMessage("ياقحبة كسمك منيوكة اختك يازبي انا انيك امك امك تمص زبي ",uid);
